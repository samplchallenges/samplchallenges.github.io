...
Currently, we are running [a SAMPL8 challenge with host-guest binding to GDCCs](https://github.com/samplchallenges/SAMPL8/tree/master/host_guest/GDCC). We also just launched a [SAMPL8 physical properties challenge](https://github.com/samplchallenges/SAMPL8/tree/master/physical_properties) on logD and pKa with data from GSK ([dataset collection details here](https://dx.doi.org/10.5281/zenodo.4245127])). **For deadlines please refer to the relevant GitHub sites.** Stay tuned for further announcements relating to the SAMPL8 phase of challenges. See our [roadmap](https://samplchallenges.github.io/roadmap/plans/) for what we can announce so far.

**Our SAMPL7 physical properties issue is now open for submission** at JCAMD, with **deadline March 31**. Be sure to include "SAMPL7" in your title and select the SAMPL7 special issue from the dropdown menu on submission. As usual, articles will mostly appear in order of submission, and articles submitted early are preferred for cover artwork. Be sure to be aware that challenge data analysis (statistics, plots, etc.) is available on the SAMPL7 GitHub repository.
